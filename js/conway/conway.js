...
export class GameOfLife {
    ...
    */
    constructor(width, height, block_size) {
        var ret = wasm.gameoflife_new(width, height, block_size);
        return GameOfLife.__wrap(ret);
    }
    /**
    */
    step() {
        wasm.gameoflife_step(this.ptr);
    }
    /**
    * @param {HTMLCanvasElement} canvas
    * @param {string} alive_color
    * @param {string} dead_color
    */
    draw(canvas, alive_color, dead_color) {
        try {
            var ptr0 = passStringToWasm0(alive_color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            var ptr1 = passStringToWasm0(dead_color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len1 = WASM_VECTOR_LEN;
            wasm.gameoflife_draw(this.ptr, addBorrowedObject(canvas), ptr0, len0, ptr1, len1);
        } finally {
